...
class HistoryItem(BaseModel):
    ...
    has_market_radar: bool = Field(False, description="Contains market_radar dashboard data")
...
class ReportDetails(BaseModel):
    ...
    kline_chart: Optional[Any] = Field(None, description="报告展示用真实日K/均线/BBI图表数据")
