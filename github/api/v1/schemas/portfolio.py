...
class PortfolioScreenshotImportPosition(BaseModel):
...
class PortfolioScreenshotImportParseResponse(BaseModel):
    suggested_account_name: str = "广发证券截图账户"
    broker_hint: Optional[str] = None
    screenshot_date: Optional[str] = None
    total_assets: Optional[float] = None
    total_cash: Optional[float] = None
    position_pct: Optional[float] = None
    record_count: int
    positions: List[PortfolioScreenshotImportPosition] = Field(default_factory=list)
    warnings: List[str] = Field(default_factory=list)
    raw_summary: Optional[str] = None


class PortfolioScreenshotImportCommitRequest(BaseModel):
    account_id: int
    import_date: date
...
class PortfolioScreenshotImportCommitResponse(PortfolioImportCommitResponse):
