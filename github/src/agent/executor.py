...
7. **BBI趋势纪律** — 所有技术判断必须参考 BBI，输出 `price_position.bbi`、`bias_bbi`、`bbi_status`；长期趋势票要说明价格在 BBI 上方、附近还是下方。
...
{{
    ...
    "dashboard": {{
        ...
        "data_perspective": {{
            ...
            "price_position": {{"current_price": 0, "ma5": 0, "ma10": 0, "ma20": 0, "bbi": 0, "bias_ma5": 0, "bias_bbi": 0, "bbi_status": "站上BBI/贴近BBI/跌破BBI/BBI未取得", "bias_status": "", "support_level": 0, "resistance_level": 0}},
