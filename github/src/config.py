...
class Config:
    ...
    def get_db_url(self) -> str:
        ...
        DATABASE_URL is used for durable cloud databases such as
        Neon/Supabase Postgres. If it is not set, local SQLite remains
        the default and its parent directory is created automatically.
        """
