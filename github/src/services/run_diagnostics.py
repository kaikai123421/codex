...
def _provider_flow_event(
    ...
    auxiliary = data_type in _AUXILIARY_PROVIDER_DATA_TYPES
    status = "degraded" if (auxiliary and not run.success) else _flow_status_for_success(run.success, fallback=fallback)
