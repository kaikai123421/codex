...
PORTFOLIO_REVIEW_REPORT_TYPES = {"portfolio", "portfolio_review"}
...
class BacktestRepository:
        ...
        with self.db.get_session() as session:
            ...
            conditions.append(
                or_(
                    ...
                    ~AnalysisHistory.report_type.in_(
                        [MARKET_REVIEW_REPORT_TYPE, *PORTFOLIO_REVIEW_REPORT_TYPES]
                    ),
                )
            )
            conditions.append(func.upper(AnalysisHistory.code) != "PORTFOLIO")
    ...
    def _build_result_conditions(
        *,
        ...
        conditions.append(func.upper(BacktestResult.code) != "PORTFOLIO")
        if eval_window_days is not None:
