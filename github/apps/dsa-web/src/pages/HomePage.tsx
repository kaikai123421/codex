...
const HomePage: React.FC = () => {
  ...
  const selectedReportCode = (selectedReport?.meta.stockCode || '').trim().toUpperCase();
  const isPortfolioDashboardReport = selectedReportCode === 'PORTFOLIO';
  const isHistoryTrendUnavailable = !selectedReport || !selectedReport.meta.stockCode || isPortfolioDashboardReport;
