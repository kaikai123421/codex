...
export interface PortfolioScreenshotImportPosition {
  name?: string | null;
  symbol: string;
  quantity: number;
...
export interface PortfolioScreenshotImportParseResponse {
  ...
  recordCount: number;
  positions: PortfolioScreenshotImportPosition[];
  warnings: string[];
  rawSummary?: string | null;
}

export interface PortfolioScreenshotImportCommitRequest {
  accountId: number;
  importDate: string;
  totalCash?: number | null;
  positions: PortfolioScreenshotImportPosition[];
...
export interface PortfolioScreenshotImportCommitResponse extends PortfolioImportCommitResponse {
  cashCalibrationAmount?: number | null;
  snapshot?: {
    totalCash?: number | null;
