...
describe('ReportOverview', () => {
  ...
  it('does not render watchlist controls for portfolio reports', () => {
  ...
  it('does not keep watchlist failure messages in the report body', () => {
    render(
      <ReportOverview
        meta={baseMeta}
        summary={baseSummary}
        watchlist={{
          ...
          onToggle: vi.fn(),
          isActioning: false,
          actionMessage: 'operation failed',
        }}
      />,
    );
