...
describe('TaskPanel', () => {
  ...
  it('renders active tasks with preserved dashboard panel styling', () => {
    ...
    expect(screen.queryByText('trace-task-1')).not.toBeInTheDocument();
  ...
  it('keeps narrow sidebar task metadata in rows instead of squeezing diagnostics vertically', () => {
    ...
    expect(screen.queryByTestId('task-panel-diagnostics-summary')).not.toBeInTheDocument();
    expect(screen.queryByText(/c5b9665a64/)).not.toBeInTheDocument();
