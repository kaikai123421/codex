...
Covers:
- _resolve_vision_model(): priority chain (vision_model > openai_vision_model > inferred vision providers)
...
class TestResolveVisionModel:
    ...
    def test_does_not_fall_back_to_primary_text_model(self):
        cfg = _cfg(openai_vision_model=None, litellm_model="deepseek/deepseek-chat")
        with patch("src.services.image_stock_extractor.get_config", return_value=cfg):
